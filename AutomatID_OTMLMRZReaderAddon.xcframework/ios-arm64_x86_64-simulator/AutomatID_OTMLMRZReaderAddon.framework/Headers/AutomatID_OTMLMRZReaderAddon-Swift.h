...
#ifndef AUTOMATID_OTMLMRZREADERADDON_SWIFT_H
#define AUTOMATID_OTMLMRZREADERADDON_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="AutomatID_OTMLMRZReaderAddon",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@property (nonatomic, copy) NSString * _Nonnull rawMRZ;
@property (nonatomic, strong) MRZModel * _Nonnull mrz;
...
SWIFT_CLASS_NAMED("MRZFrenchIdCard")
@interface MRZFrenchIdCard : MRZParser
...
@class NSDate;
SWIFT_CLASS_NAMED("MRZModel")
@interface MRZModel : NSObject
...
@property (nonatomic, copy) NSString * _Nonnull dateOfBirthString;
@property (nonatomic, copy) NSString * _Nonnull expirationDateString;
...
@class UIImage;
SWIFT_CLASS_NAMED("PassportScanner")
@interface PassportScanner : NSObject
...
@property (nonatomic) enum MRZType mrzType;
@property (nonatomic, copy) NSString * _Nullable tesseractTrainedDataAbsolutePath;
@property (nonatomic) BOOL setupCompleted;
- (void)setup;
/// Perform the tesseracttesseract OCR on an image.
/// \param image The image to be scanned
///
/// \param completion the closure has the OCR result as a parameter
///
- (UIImage * _Nonnull)clarifyWithSourceImage:(UIImage * _Nonnull)sourceImage SWIFT_WARN_UNUSED_RESULT;
- (void)completionedParseImageWithSourceImage:(UIImage * _Nonnull)sourceImage completion:(void (^ _Nonnull)(MRZModel * _Nullable))completion;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
