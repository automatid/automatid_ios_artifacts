...
@interface PassportScanner : NSObject <MGTesseractDelegate>
...
- (void)setup;
- (UIImage * _Null_unspecified)preprocessedImageForTesseract:(MGTesseract * _Null_unspecified)tesseract sourceImage:(UIImage * _Null_unspecified)sourceImage SWIFT_WARN_UNUSED_RESULT;
- (MRZModel * _Null_unspecified)parseImageWithSourceImage:(UIImage * _Nonnull)sourceImage SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
