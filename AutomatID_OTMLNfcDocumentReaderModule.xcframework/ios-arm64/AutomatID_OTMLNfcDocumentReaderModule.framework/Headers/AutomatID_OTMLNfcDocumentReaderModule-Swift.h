...
#ifndef AUTOMATID_OTMLNFCDOCUMENTREADERMODULE_SWIFT_H
#define AUTOMATID_OTMLNFCDOCUMENTREADERMODULE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="AutomatID_OTMLNfcDocumentReaderModule",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC37AutomatID_OTMLNfcDocumentReaderModule14PassportReader") SWIFT_AVAILABILITY(ios,introduced=13)
