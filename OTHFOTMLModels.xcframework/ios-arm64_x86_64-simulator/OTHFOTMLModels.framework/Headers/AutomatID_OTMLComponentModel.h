...
#import <OTHFOTTBXML/AutomatID_OTTBXML.h>
...
extern NSString* const t_AutomatID_Component_otml_component_did_enter_in_error_state;
extern NSString* const t_AutomatID_Component_otml_component_did_exit_from_error_state;
extern NSString* const t_AutomatID_Component_did_show;


//All parameters that are accepted in INPUT by this component
extern NSString* const p_AutomatID_Component_ios_no_animation;
extern NSString* const p_AutomatID_Component_component_name;
extern NSString* const p_AutomatID_Component_animation;
extern NSString* const p_AutomatID_Component_width;
extern NSString* const p_AutomatID_Component_height;
extern NSString* const p_AutomatID_Component_padding;
extern NSString* const p_AutomatID_Component_margin;
extern NSString* const p_AutomatID_Component_visibility;
extern NSString* const p_AutomatID_Component_add_event_observer;
extern NSString* const p_AutomatID_Component_add_and_init_event_observer;
extern NSString* const p_AutomatID_Component_remove_event_observer;
extern NSString* const p_AutomatID_Component_otml_validationexception_error_message;
extern NSString* const p_AutomatID_Component_bg_image_n;
extern NSString* const p_AutomatID_Component_bg_image_p;
extern NSString* const p_AutomatID_Component_bg_image_s;
extern NSString* const p_AutomatID_Component_bg_image_sp;
extern NSString* const p_AutomatID_Component_bg_image_d;
extern NSString* const p_AutomatID_Component_bg_image_sd;
extern NSString* const p_AutomatID_Component_bg_image_ne;
extern NSString* const p_AutomatID_Component_bg_image_pe;
extern NSString* const p_AutomatID_Component_bg_image_se;
extern NSString* const p_AutomatID_Component_bg_image_spe;
extern NSString* const p_AutomatID_Component_color_n;
extern NSString* const p_AutomatID_Component_color_p;
extern NSString* const p_AutomatID_Component_color_s;
extern NSString* const p_AutomatID_Component_color_sp;
extern NSString* const p_AutomatID_Component_color_d;
extern NSString* const p_AutomatID_Component_color_sd;
extern NSString* const p_AutomatID_Component_color_ne;
extern NSString* const p_AutomatID_Component_color_pe;
extern NSString* const p_AutomatID_Component_color_se;
extern NSString* const p_AutomatID_Component_color_spe;
extern NSString* const p_AutomatID_Component_error;
extern NSString* const p_AutomatID_Component_error_delegate;
extern NSString* const p_AutomatID_Component_enabled;
extern NSString* const p_AutomatID_Component_selected;
extern NSString* const p_AutomatID_Component_disabled_alpha;
extern NSString* const p_AutomatID_Component_fill_factor;
extern NSString* const p_AutomatID_Component_accessibility_disabled;
extern NSString* const p_AutomatID_Component_accessibility_hint;
extern NSString* const p_AutomatID_Component_accessibility_text;
extern NSString* const p_AutomatID_Component_voiceover_group;
extern NSString* const p_AutomatID_Component_accessibility_index;
//All parameters that are accepted in OUTPUT by this component
extern NSString* const f_AutomatID_Component_error;
extern NSString* const f_AutomatID_Component_visibility;
extern NSString* const f_AutomatID_Component_resolved_row;
extern NSString* const f_AutomatID_Component_resolved_section;
extern NSString* const f_AutomatID_Component_selected;
extern NSString* const f_AutomatID_Component_enabled;
extern NSString* const f_AutomatID_Component_is_in_error_state;

@interface AutomatID_OTMLComponentModel : NSObject<NSCopying>
...
*/
@property(nonatomic, strong) AutomatID_OTMPColor* border_color_n;
...
*/
@property(nonatomic, strong) AutomatID_OTMPColor* color_d;
...
*/
@property(nonatomic, strong) AutomatID_OTMPColor* color_n;
...
*/
@property(nonatomic, strong) AutomatID_OTMPColor* color_ne;
...
@return The Pressed Background Color
*/
@property(nonatomic, strong) AutomatID_OTMPColor* color_p;
...
*/
@property(nonatomic, strong) AutomatID_OTMPColor* color_pe;
...
*/
@property(nonatomic, strong) AutomatID_OTMPColor* color_s;
...
@return The Pressed Background Color
*/
@property(nonatomic, strong) AutomatID_OTMPColor* color_sd;
...
*/
@property(nonatomic, strong) AutomatID_OTMPColor* color_se;
...
@return The Pressed Background Color
*/
@property(nonatomic, strong) AutomatID_OTMPColor* color_sp;
...
*/
@property(nonatomic, strong) AutomatID_OTMPColor* color_spe;
...
*/
@property(nonatomic, assign) AutomatID_OTMLComponentErrorMode error_mode;
...
*/
@property(nonatomic, assign) AutomatID_OTMLVisibility visibility;
