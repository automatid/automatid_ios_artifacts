...
extern NSString* const t_AutomatID_HintedTextField_hint_selected;


//All parameters that are accepted in INPUT by this component
extern NSString* const p_AutomatID_HintedTextField_reference_hint_datasource;
//All parameters that are accepted in OUTPUT by this component
extern NSString* const f_AutomatID_HintedTextField_hint_resp;
extern NSString* const f_AutomatID_HintedTextField_hint_resp1;
extern NSString* const f_AutomatID_HintedTextField_hint_resp2;
extern NSString* const f_AutomatID_HintedTextField_hint_resp3;
extern NSString* const f_AutomatID_HintedTextField_hint_resp4;
extern NSString* const f_AutomatID_HintedTextField_hint_resp5;
extern NSString* const f_AutomatID_HintedTextField_hint_resp6;
extern NSString* const f_AutomatID_HintedTextField_hint_resp7;
extern NSString* const f_AutomatID_HintedTextField_hint_resp8;
extern NSString* const f_AutomatID_HintedTextField_hint_resp9;
extern NSString* const f_AutomatID_HintedTextField_hint_resp10;
extern NSString* const f_AutomatID_HintedTextField_hint_resp11;
extern NSString* const f_AutomatID_HintedTextField_hint_resp12;
extern NSString* const f_AutomatID_HintedTextField_hint_resp13;
extern NSString* const f_AutomatID_HintedTextField_hint_resp14;
extern NSString* const f_AutomatID_HintedTextField_hint_resp15;

@interface AutomatID_OTMLHintedTextFieldModel : AutomatID_OTMLTextFieldModel<NSCopying>

    @property(nonatomic, strong) AutomatID_OTMPColor* hint_bg_color;


@property(nonatomic, strong) AutomatID_OTMPColor* hint_bg_color_row_normal;


@property(nonatomic, strong) AutomatID_OTMPColor* hint_bg_color_row_pressed;
...
@property(nonatomic, strong) AutomatID_OTMLFont* hint_highlight_font;


@property(nonatomic, strong) NSString* hint_label_ds_path;


@property(nonatomic, strong) AutomatID_OTMLFont* hint_label_font;
...
@property(nonatomic, strong) AutomatID_OTMLFont* hint_payload_font;


@property(nonatomic, assign) NSInteger hint_resp_count;


@property(nonatomic, strong) AutomatID_OTMPColor* hint_separator_row_color;
