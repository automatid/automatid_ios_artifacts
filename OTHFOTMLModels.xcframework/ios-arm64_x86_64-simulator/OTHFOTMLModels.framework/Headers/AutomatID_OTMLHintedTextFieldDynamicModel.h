...
extern NSString* const t_AutomatID_HintedTextFieldDynamic_refresh;


//All parameters that are accepted in INPUT by this component
extern NSString* const p_AutomatID_HintedTextFieldDynamic_network_target;

@interface AutomatID_OTMLHintedTextFieldDynamicModel : AutomatID_OTMLHintedTextFieldModel<NSCopying>
