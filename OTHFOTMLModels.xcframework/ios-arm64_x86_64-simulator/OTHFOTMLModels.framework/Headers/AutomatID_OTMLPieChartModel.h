...
extern NSString* const t_AutomatID_PieChart_refresh;


//All parameters that are accepted in INPUT by this component
extern NSString* const p_AutomatID_PieChart_ds_path;
extern NSString* const p_AutomatID_PieChart_value_param_ref;
extern NSString* const p_AutomatID_PieChart_slice_color_param_ref;

@interface AutomatID_OTMLPieChartModel : AutomatID_OTMLComponentModel<NSCopying>
