...
extern NSString* const t_AutomatID_LineChart_did_select_point;
extern NSString* const t_AutomatID_LineChart_did_select_point_from_parameter;
//All triggers that are allowed by this component
extern NSString* const t_AutomatID_LineChart_refresh;


//All parameters that are accepted in INPUT by this component
extern NSString* const p_AutomatID_LineChart_bullet_modulo;
extern NSString* const p_AutomatID_LineChart_ds_path;
extern NSString* const p_AutomatID_LineChart_x_value_param_ref;
extern NSString* const p_AutomatID_LineChart_y_value_param_ref;
extern NSString* const p_AutomatID_LineChart_x_label_param_ref;
extern NSString* const p_AutomatID_LineChart_y_label_param_ref;
extern NSString* const p_AutomatID_LineChart_point_description_param_ref;
extern NSString* const p_AutomatID_LineChart_selected_point_index;
//All parameters that are accepted in OUTPUT by this component
extern NSString* const f_AutomatID_LineChart_selected_point_index;
extern NSString* const f_AutomatID_LineChart_x_selected_value;
extern NSString* const f_AutomatID_LineChart_y_selected_value;
extern NSString* const f_AutomatID_LineChart_x_selected_label;
extern NSString* const f_AutomatID_LineChart_y_selected_label;
extern NSString* const f_AutomatID_LineChart_point_selected_description;

@interface AutomatID_OTMLLineChartModel : AutomatID_OTMLComponentModel<NSCopying>

    /**
    @discussion  axis_bg_color the color of the axis area containing the labels
    @note optional
    */
    @property(nonatomic, strong) AutomatID_OTMPColor* axis_bg_color;
...
@note optional
*/
@property(nonatomic, strong) AutomatID_OTMPColor* axis_line_color;


@property(nonatomic, assign) NSInteger axis_line_thickness;


@property(nonatomic, assign) AutomatID_OTMLCartesianGridLineType axis_line_type;


@property(nonatomic, strong) AutomatID_OTMLFont* balloon_font;
...
@property(nonatomic, strong) AutomatID_OTMPColor* horizontal_gridlines_color;
...
@property(nonatomic, assign) AutomatID_OTMLCartesianGridLineType horizontal_gridlines_type;
...
@note optional
*/
@property(nonatomic, strong) AutomatID_OTMPColor* inter_point_stacked_color;
...
@note required
*/
@property(nonatomic, strong) AutomatID_OTMPColor* line_color;
...
@property(nonatomic, assign) AutomatID_OTMLCartesianGridLineType line_type;
...
@note optional
*/
@property(nonatomic, strong) AutomatID_OTMPColor* line_vertical_color;


@property(nonatomic, assign) NSInteger line_vertical_thickness;


@property(nonatomic, assign) AutomatID_OTMLCartesianGridLineType line_vertical_type;
...
@property(nonatomic, assign) AutomatID_OTMLCartesianPointSelectionMode point_selection_mode;
...
@property(nonatomic, strong) AutomatID_OTMPColor* selected_point_line_color;


@property(nonatomic, assign) NSInteger selected_point_line_thickness;


@property(nonatomic, assign) AutomatID_OTMLCartesianGridLineType selected_point_line_type;
...
@note optional
*/
@property(nonatomic, strong) AutomatID_OTMPColor* stacked_area_color;
...
@property(nonatomic, strong) AutomatID_OTMLFont* x_axis_font;
...
@property(nonatomic, strong) AutomatID_OTMLFont* y_axis_font;
