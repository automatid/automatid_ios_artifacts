...
extern NSString* const t_AutomatID_TextField_text_changed_from_parameter;
extern NSString* const t_AutomatID_TextField_did_begin_edit;
extern NSString* const t_AutomatID_TextField_did_end_edit;
extern NSString* const t_AutomatID_TextField_text_changed;
extern NSString* const t_AutomatID_TextField_did_clear;
//All triggers that are allowed by this component
extern NSString* const t_AutomatID_TextField_goto_next_textinput;
extern NSString* const t_AutomatID_TextField_goto_prev_textinput;
extern NSString* const t_AutomatID_TextField_on_focus;


//All parameters that are accepted in INPUT by this component
extern NSString* const p_AutomatID_TextField_text_and_cursor_json;
extern NSString* const p_AutomatID_TextField_placeholder;
extern NSString* const p_AutomatID_TextField_color_f;
extern NSString* const p_AutomatID_TextField_color_fe;
extern NSString* const p_AutomatID_TextField_bg_image_f;
extern NSString* const p_AutomatID_TextField_bg_image_fe;
extern NSString* const p_AutomatID_TextField_left_image;
extern NSString* const p_AutomatID_TextField_left_image_p;
extern NSString* const p_AutomatID_TextField_left_image_s;
extern NSString* const p_AutomatID_TextField_left_image_f;
extern NSString* const p_AutomatID_TextField_left_image_d;
extern NSString* const p_AutomatID_TextField_right_image;
extern NSString* const p_AutomatID_TextField_right_image_p;
extern NSString* const p_AutomatID_TextField_right_image_s;
extern NSString* const p_AutomatID_TextField_right_image_f;
extern NSString* const p_AutomatID_TextField_right_image_d;
extern NSString* const p_AutomatID_TextField_input_keyboard_type;

@interface AutomatID_OTMLTextFieldModel : AutomatID_OTMLAbstractTextComponentModel<NSCopying>
...
*/
@property(nonatomic, assign) AutomatID_OTMLTextInputCasing input_enforced_casing;
...
*/
@property(nonatomic, assign) AutomatID_OTMLInputKeyboardType input_keyboard_type;


/**
Casing applied to placeholder text
*/
@property(nonatomic, assign) AutomatID_OTMLTextCasing input_suggestion_casing;
...
Casing applied to placeholder text
*/
@property(nonatomic, assign) AutomatID_OTMLTextCasing placeholder_casing;
