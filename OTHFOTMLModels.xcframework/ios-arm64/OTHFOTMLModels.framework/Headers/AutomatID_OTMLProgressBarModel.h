...
extern NSString* const p_AutomatID_ProgressBar_value;
extern NSString* const p_AutomatID_ProgressBar_max_value;
extern NSString* const p_AutomatID_ProgressBar_min_value;
//All parameters that are accepted in OUTPUT by this component
extern NSString* const f_AutomatID_ProgressBar_value;

@interface AutomatID_OTMLProgressBarModel : AutomatID_OTMLComponentModel<NSCopying>

    @property(nonatomic, strong) NSString* content_image;


@property(nonatomic, strong) AutomatID_OTMPColor* empty_color_e;


@property(nonatomic, strong) AutomatID_OTMPColor* empty_color_s;


@property(nonatomic, strong) AutomatID_OTMPColor* fill_color_e;


@property(nonatomic, strong) AutomatID_OTMPColor* fill_color_s;
