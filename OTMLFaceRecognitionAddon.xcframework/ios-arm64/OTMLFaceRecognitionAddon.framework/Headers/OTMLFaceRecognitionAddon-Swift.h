...
#ifndef OTMLFACERECOGNITIONADDON_SWIFT_H
#define OTMLFACERECOGNITIONADDON_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="OTMLFaceRecognitionAddon",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC24OTMLFaceRecognitionAddon37FaceRecognitionCustomComponentFactory")
...
SWIFT_CLASS("_TtC24OTMLFaceRecognitionAddon33OTMLFaceRecognitionActionReceiver")
...
SWIFT_CLASS("_TtC24OTMLFaceRecognitionAddon28OTMLFaceRecognitionComponent")
