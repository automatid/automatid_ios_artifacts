...
#ifndef OTHFOTMLFACERECOGNITIONADDON_SWIFT_H
#define OTHFOTMLFACERECOGNITIONADDON_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="OTHFOTMLFaceRecognitionAddon",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC28OTHFOTMLFaceRecognitionAddon37FaceRecognitionCustomComponentFactory")
...
SWIFT_CLASS("_TtC28OTHFOTMLFaceRecognitionAddon33OTMLFaceRecognitionActionReceiver")
...
@class UIView;
@class NSString;
SWIFT_CLASS("_TtC28OTHFOTMLFaceRecognitionAddon28OTMLFaceRecognitionComponent")
...
- (void)atHideView:(UIView * _Null_unspecified)aView;
