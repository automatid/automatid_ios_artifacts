...
extern NSString* const t_AutomatID_Label_did_click_link;


//All parameters that are accepted in INPUT by this component
extern NSString* const p_AutomatID_Label_adjusts_font_size;
extern NSString* const p_AutomatID_Label_max_lines;
//All parameters that are accepted in OUTPUT by this component
extern NSString* const f_AutomatID_Label_last_clicked_link;

@interface AutomatID_OTMLLabelModel : AutomatID_OTMLAbstractTextComponentModel<NSCopying>
...
*/
@property(nonatomic, assign) AutomatID_OTMLTextCasing text_casing;
