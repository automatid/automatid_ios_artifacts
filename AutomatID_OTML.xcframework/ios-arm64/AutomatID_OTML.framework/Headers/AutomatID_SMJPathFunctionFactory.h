...
@interface AutomatID_SMJPathFunctionFactory : NSObject

// -- Instance --
+ (nullable id <AutomatID_SMJPathFunction>)pathFunctionForName:(NSString *)name error:(NSError **)error;
