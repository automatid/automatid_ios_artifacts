//
//  AutomatID_OTMLRemoteNavigator.h
//  OTML
//
//  Created by Valerio Ferrantelli on 24/05/2019.
//

@protocol AutomatID_OTMLNetworkTaskDelegate;
...
@interface AutomatID_OTMLRemoteNavigator : NSObject <AutomatID_OTMLRestartAppAwareProtocol>
...
-(void) processTask:(AutomatID_OTMLNetworkTask *)aTask didFinishWithResponse:(AutomatID_OTMLNetworkResponse *)response;
...
@interface AutomatID_OTMLDictionaryNetworkRequest : NSObject
