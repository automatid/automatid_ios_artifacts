...
@interface AutomatID_OTMLNotificationCenterManager : NSObject <AutomatID_OTMLRestartAppAwareProtocol>
...
+(nonnull AutomatID_OTMLNotificationCenterManager*)getInstance;
