...
@interface AutomatID_OTMLUpdTraceModel : AutomatID_OTMLTraceModel
...
- (instancetype)initWithUpdaterDelegate:(AutomatID_OTMLAdvancedUpdaterDelegateBase*)updaterDelegate;
