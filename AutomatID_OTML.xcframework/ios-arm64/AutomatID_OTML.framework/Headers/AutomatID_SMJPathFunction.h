 ...
 */
@protocol AutomatID_SMJPathFunction <NSObject>
 ...
 *
 */
- (nullable id)invokeWithCurrentPathString:(NSString *)currentPath parentPath:(AutomatID_SMJPathRef *)parentPath jsonObject:(id)jsonObject evaluationContext:(id <AutomatID_SMJEvaluationContext>)context parameters:(nullable NSArray <AutomatID_SMJParameter *> *)parameters error:(NSError **)error;
