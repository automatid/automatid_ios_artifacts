...
typedef enum AutomatID_SMJEvaluationContinuation
{
...
@protocol AutomatID_SMJFoundResult <NSObject>
...
@protocol AutomatID_SMJEvaluationListener <NSObject>
 ...
 */
- (SMJEvaluationContinuation)resultFound:(id <AutomatID_SMJFoundResult>)found;
