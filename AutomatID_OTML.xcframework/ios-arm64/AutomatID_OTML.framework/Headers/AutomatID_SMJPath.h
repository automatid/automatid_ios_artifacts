...
@protocol AutomatID_SMJPath <NSObject>
 ...
 */
- (nullable id <AutomatID_SMJEvaluationContext>)evaluateJsonObject:(id)jsonObject rootJsonObject:(id)rootJsonObject configuration:(AutomatID_SMJConfiguration *)configuration error:(NSError **)error;
 ...
 * @return EvaluationContext containing results of evaluation
 */
- (nullable id <AutomatID_SMJEvaluationContext>)evaluateJsonObject:(id)jsonObject rootJsonObject:(id)rootJsonObject configuration:(AutomatID_SMJConfiguration *)configuration forUpdate:(BOOL)forUpdate error:(NSError **)error;
