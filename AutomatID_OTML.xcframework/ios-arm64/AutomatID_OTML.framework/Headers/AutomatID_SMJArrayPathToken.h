...
@interface AutomatID_SMJArrayPathToken : AutomatID_SMJPathToken

- (SMJArrayPathCheck)checkArrayWithCurrentPathString:(NSString *)currentPath jsonObject:(id)jsonObject evaluationContext:(AutomatID_SMJEvaluationContextImpl *)context error:(NSError **)error;
