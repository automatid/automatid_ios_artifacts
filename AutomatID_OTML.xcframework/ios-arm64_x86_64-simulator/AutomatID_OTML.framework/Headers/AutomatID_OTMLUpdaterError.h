...
typedef NS_OPTIONS(unsigned int, AutomatID_OTMLUpdateError) {
...
@interface AutomatID_OTMLUpdaterError : NSObject

+(NSError*)errorWithCode:(AutomatID_OTMLUpdateError)aCode;
