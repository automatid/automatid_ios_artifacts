//
//  AutomatID_OTMLParameterToParEntryResolution.h
//  OTMLFramework
//
...
typedef enum {
    AutomatID_OTMLParameterToParEntryAsyncResolutionError_generic=0,
    AutomatID_OTMLParameterToParEntryAsyncResolutionError_noParamFound=1,
    AutomatID_OTMLParameterToParEntryAsyncResolutionError_asyncPrevalidationError=2,
    AutomatID_OTMLParameterToParEntryAsyncResolutionError_ValidationError=3
} AutomatID_OTMLParameterToParEntryAsyncResolutionError;

#define OTMLPARAMETERTOPARENTRYASYNCRESOLUTIONERRORDOMAIN @"AutomatID_OTMLParameterToParEntryAsyncResolutionErrorDomain"

@interface AutomatID_OTMLResolveParameterRefConfiguration : NSObject

- (nullable instancetype) initWithRefID:(nonnull NSString*)aParameterRefID
                               withOTVC:(nullable AutomatID_OTMLViewController*)aOTVC
                          parameterPath:(nullable NSString*) dsPath
                orSingleIndexResolution:(NSInteger) singleIndex
                        parentComponent:(nullable AutomatID_OTMLComponent*)aParentComponent;

- (nullable instancetype) initWithRefID:(nonnull NSString*)aParameterRefID
                               withOTVC:(nullable AutomatID_OTMLViewController*)aOTVC
                                 stubDS:(nonnull AutomatID_OTMLDatasource*) stubDS
                  singleIndexResolution:(NSInteger) singleIndex
                        parentComponent:(nullable AutomatID_OTMLComponent*)aParentComponent;

@property(nonatomic, readonly) NSString* __nonnull parameterRefID;
@property(nonatomic, readonly) AutomatID_OTMLViewController* __nullable otVC;
@property(nonatomic, readonly) NSString* __nullable dsPath;
@property(nonatomic, readonly) AutomatID_OTMLDatasource* __nullable stubDS;
@property(nonatomic, readonly) NSInteger index;
@property(nonatomic, readonly) AutomatID_OTMLComponent* __nullable parentComponent;

@end


@interface AutomatID_OTMLParameterToParEntryResolution : NSObject

+(nullable AutomatID_OTMLParameterEntry*) entryFromUnresolvedParamether:(nonnull AutomatID_OTMLParameter*) theUnresolvedParam
                                                 usingFetcher:(nullable id<AutomatID_OTMLParameterDataFetcher>) aParamDataFetcher
 ...
 */
+(nullable AutomatID_OTMLParameter*) findParamRefWithID:(nullable NSString*) aParamRefID
                          fromSourceComponent:(nullable AutomatID_OTMLComponent*) aSourceComponent
                     orFromAutomatID_OTMLViewController:(nullable AutomatID_OTMLViewController*)aOTVC;
 ...
 */
+(void) asyncResolveIfSupportedByParameterRef:(nonnull AutomatID_OTMLParameter*) aParamRef
                         usingSourceComponent:(nullable AutomatID_OTMLComponent*)aSourceComponent
                     orFromAutomatID_OTMLViewController:(nullable AutomatID_OTMLViewController*) aOTVC
                       preValidationCodeBlock:(BOOL (^ __nullable)(AutomatID_OTMLParameter* __nonnull paramRef, AutomatID_OTMLParamModeStrategy* __nullable parameterModeStrategy))preValidationBlock
                  preResolveSubParamCodeBlock:(void (^ __nullable)(AutomatID_OTMLParameter* __nonnull paramRef, AutomatID_OTMLParamModeStrategy* __nullable parameterModeStrategy))preResolveSubParamBlock
                onResolutionCompleteCodeBlock:(void (^ __nonnull)(AutomatID_OTMLParameterEntry* __nullable resolvedParameter))onResolutionCompleteBlock
 ...
 */
+(nullable NSArray*)resolveAsArrayWithParameterRefConfig:(AutomatID_OTMLResolveParameterRefConfiguration*__nonnull) aConfiguration
...
/**
 ...
 @return the NSArray<AutomatID_OTMLParameter*>
 **/
+(nullable NSArray <AutomatID_OTMLParameter *> *)arrayOfImageManipulationParamRefFromString:(nullable NSString*)aImageManipulationsString
                                                              fromSourceComponent:(nullable AutomatID_OTMLComponent*) aSourceComponent
                                                         orFromAutomatID_OTMLViewController:(nullable AutomatID_OTMLViewController*) aOTVC;
@end
