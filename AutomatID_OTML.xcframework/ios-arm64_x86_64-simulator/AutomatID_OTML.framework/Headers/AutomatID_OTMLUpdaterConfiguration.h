...
@interface AutomatID_OTMLUpdaterConfiguration : NSObject
...
+(AutomatID_OTMLUpdaterConfiguration*)currentConfiguration;
+(void)setCurrentConfiguration:(AutomatID_OTMLUpdaterConfiguration*)aConf;
