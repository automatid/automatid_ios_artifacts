//
//  AutomatID_OTMLExternalEventModel.h
//  OTMLFramework
//
...
typedef NS_OPTIONS(unsigned int, AutomatID_OTMLExternalEventType) {
 ...
 **/
typedef NS_OPTIONS(unsigned int, AutomatID_OTMLAppState) {
...
@interface AutomatID_OTMLExternalEventTypeSupport : NSObject
+(AutomatID_OTMLExternalEventType) valueFromString:(nullable NSString*) aStringValue;
+(nonnull NSString*) representationStringFromValue:(AutomatID_OTMLExternalEventType) aValue;
+(nonnull NSArray<NSString*>*)stringComponentsFromValue:(AutomatID_OTMLExternalEventType) aValue;
+(nullable NSString*) ensuredSingleValidStringFromValue:(AutomatID_OTMLExternalEventType) aValue;
+(AutomatID_OTMLAppState) appStateFromUIApplicationState:(UIApplicationState)aState;
@end
...
@class AutomatID_OTMLConcreteEventModel;


@interface AutomatID_OTMLExternalEventModel : NSObject <NSCopying, NSCoding>

#pragma mark - serialized in meta ds
@property (nonatomic, assign) BOOL isTapped;
@property (nonatomic, assign) AutomatID_OTMLAppState originalAppState;
@property (nonatomic, assign) AutomatID_OTMLExternalEventType eventType;
...
-(nonnull instancetype)initWithType:(AutomatID_OTMLExternalEventType)aType;

-(void) saveEvent;
-(void) deleteEvent;

+(nonnull AutomatID_OTMLExternalEventModel*)loadEventWithFullpath:(nonnull NSString*)aFullpath;
...
@interface AutomatID_OTMLConcreteEventModel : NSObject
-(void)populateExternalEventPayload:(AutomatID_OTMLExternalEventModel*_Nonnull)anEvent;
@end
