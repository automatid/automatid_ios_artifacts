//
//  AutomatID_OTMLJSEngineManager.h
//  OTMLFramework
//
...
+(BOOL)jsB64CallbackExecutionWithString:(NSString*) b64RequestString onViewController:(AutomatID_OTMLViewController*)aViewController;
