//
//  AutomatID_OTMLPushNotificationModel.h
//  OTMLFramework
//
...
extern NSString* const t_AutomatID_push_notification_payload_dictionary;

@interface AutomatID_OTMLPushNotificationModel : AutomatID_OTMLConcreteEventModel
