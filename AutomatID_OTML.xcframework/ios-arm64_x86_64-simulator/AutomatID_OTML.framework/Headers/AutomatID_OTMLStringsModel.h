...
@interface AutomatID_OTMLStringsModel : NSObject
...
-(NSString*)getCurrentLangPhraseFromPlaceholder:(NSString*)_placeholder wihType:(AutomatID_OTMLTextResolutionMode)_type;
-(NSString*)getCurrentLangPhraseFromPlaceholder:(NSString*)_placeholder wihType:(AutomatID_OTMLTextResolutionMode)_type withOTMLVC:(AutomatID_OTMLViewController*)_theVC;
