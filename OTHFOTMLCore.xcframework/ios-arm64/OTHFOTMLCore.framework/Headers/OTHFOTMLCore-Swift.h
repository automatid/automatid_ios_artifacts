...
#ifndef OTHFOTMLCORE_SWIFT_H
#define OTHFOTMLCORE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="OTHFOTMLCore",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class UIWindow;
@class UIWindowScene;
SWIFT_CLASS("_TtC12OTHFOTMLCore28AutomatID_WindowSceneAdaptor")
...
SWIFT_CLASS("_TtC12OTHFOTMLCore10OTOSLogger")
