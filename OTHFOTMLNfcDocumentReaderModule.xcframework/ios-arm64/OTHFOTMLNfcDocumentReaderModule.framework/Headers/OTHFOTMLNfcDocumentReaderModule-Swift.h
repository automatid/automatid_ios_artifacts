...
#ifndef OTHFOTMLNFCDOCUMENTREADERMODULE_SWIFT_H
#define OTHFOTMLNFCDOCUMENTREADERMODULE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="OTHFOTMLNfcDocumentReaderModule",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC31OTHFOTMLNfcDocumentReaderModule25OTNFCDRScanActionReceiver")
...
SWIFT_CLASS("_TtC31OTHFOTMLNfcDocumentReaderModule25OTNFCDRScanDocumentAction")
...
SWIFT_CLASS("_TtC31OTHFOTMLNfcDocumentReaderModule14PassportReader") SWIFT_AVAILABILITY(ios,introduced=13)
