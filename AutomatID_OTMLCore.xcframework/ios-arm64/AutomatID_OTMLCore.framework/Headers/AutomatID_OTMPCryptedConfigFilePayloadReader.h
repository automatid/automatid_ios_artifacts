...
@interface AutomatID_OTMPCryptedConfigFilePayload : NSObject
...
@interface AutomatID_OTMPCryptedConfigFilePayloadReader : NSObject

-(instancetype) initWithConfigurationErrorDomain:(NSString*) aErrorDOmain;

-(nullable AutomatID_OTMPCryptedConfigFilePayload*) configurationFromCyptedFileAtPath:(NSString*) filePath
