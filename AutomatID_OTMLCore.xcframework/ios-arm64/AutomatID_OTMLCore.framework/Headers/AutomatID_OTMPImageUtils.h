...
@interface AutomatID_OTMPImageWithFrame : NSObject
...
@interface AutomatID_OTMPImageUtils : NSObject
...
/**
 ...
 @see [AutomatID_OTMPImageUtils getRoundedMaskWithRect:radiustl:radiustr:radiusbl:radiusbr:]
 **/
...
/**
 simila to [AutomatID_OTMPImageUtils getScreenShotOfVIew:fromVRam:] using fromVRam: NO
 @see [AutomatID_OTMPImageUtils getScreenShotOfVIew:fromVRam:]
 **/
+ (nullable UIImage*) getScreenShotOfVIew:(nullable UIView*) view;
...
/**
 ...
 @see [AutomatID_OTMPImageUtils imageBlurring:withBlurRadius:]
 **/
+ (nullable UIImage *)imageBlurring:(nullable UIImage *)image;
...
+(nonnull UIImage *)image:(nonnull UIImage*)backgroundImage addingOnTop:(nonnull NSArray<AutomatID_OTMPImageWithFrame*>*) imagesToAdd;
