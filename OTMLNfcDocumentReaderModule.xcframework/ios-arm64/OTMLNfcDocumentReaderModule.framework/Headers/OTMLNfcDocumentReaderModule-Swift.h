...
#ifndef OTMLNFCDOCUMENTREADERMODULE_SWIFT_H
#define OTMLNFCDOCUMENTREADERMODULE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="OTMLNfcDocumentReaderModule",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC27OTMLNfcDocumentReaderModule25OTNFCDRScanActionReceiver")
...
SWIFT_CLASS("_TtC27OTMLNfcDocumentReaderModule25OTNFCDRScanDocumentAction")
