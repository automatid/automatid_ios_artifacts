...
extern NSString* const c_OTMLBeanSkinConstants_android_textfield_placeholder_color;

extern NSString* const c_OTMLBeanSkinConstants_default_statusbar_color_v2;

extern NSString* const c_OTMLBeanSkinConstants_default_statusbar_dark_elements_v2;
