//
//  AutomatID_OTMLImageManipulator.h
//  OTMLFramework
//
...
} AutomatID_OTMLImageManipulatorScaleMode;
 ...
 */
@interface AutomatID_OTMLImageManipulatorCropConfig : NSObject

-(nonnull instancetype)initWithResolvedParams:(nullable NSArray<AutomatID_OTMLParameterEntry*>*) resolvedParams defaultOriginXPerc:(nullable NSNumber*)defXPerc defaultOriginYPerc:(nullable NSNumber*)defYPerc;
...
/**
 ...
 keep aspect ratio: Durante la scalatura si assume implicitamente true se è data una sola dimensione di scaling (in tal caso la dimensione non fornita sarà calcolata automaticamente secondo il rapporto di scala). Qualora invece sono fornite entrambe le dimensioni di scaling (with, height) si assume implicitamente keep aspect ratio come false
  @see <a href="http://wiki.opentech.com/doku.php?id=otml:pmode_image_manipulation">Parameter mode image_manipulation</a>
 */
@interface AutomatID_OTMLImageManipulatorScaleConfig : NSObject

-(nonnull instancetype)initWithResolvedParams:(nullable NSArray<AutomatID_OTMLParameterEntry*>*) resolvedParams;
...
@property (nonatomic, readonly) BOOL isWidthAbs;
@property (nonatomic, readonly) BOOL isHeightAbs;
@property (nonatomic, readonly) AutomatID_OTMLImageManipulatorScaleMode scaleMode;
...
@interface AutomatID_OTMLImageManipulator : NSObject

- (nonnull instancetype) init __attribute__((unavailable("init not available")));
- (nonnull instancetype) initWithOTMLImage:(nonnull AutomatID_OTMLImage*)aOTMLImage;
 ...
 **/
- (void) cropWithCropConfig:(nullable AutomatID_OTMLImageManipulatorCropConfig*) aConfig;
- (void) scaleToSize:(CGSize)aSize;
- (void) scaleWithScaleConfig:(nullable AutomatID_OTMLImageManipulatorScaleConfig*) aConfig;
- (nullable AutomatID_OTMLImage*) manipulatedImage;
 ...
 */
+(nullable AutomatID_OTMLImage*) transformImage:(nullable AutomatID_OTMLImage*)srcImage usingTransformStringDirectivities:(nullable NSArray<NSString*>*) imageDirectivities;
...
/**
 ...
 @return the manipulated image
 */
+(nullable AutomatID_OTMLImage*) transformImage:(nullable AutomatID_OTMLImage*)srcImage multipliedBycolor:(nullable UIColor*)aColor;
...
/**
 ...
 @return the manipulated image
 */
+(nullable AutomatID_OTMLImage*) transformImage:(nullable AutomatID_OTMLImage*)srcImage blurredWithRadius:(CGFloat)aBlurRadius;
...
/**
 ...
 @return the manipulated image
 */
+(nullable AutomatID_OTMLImage*) transformImage:(nullable AutomatID_OTMLImage*)srcImage rotatedByAngle:(CGFloat)degree;
...
/**
 ...
 @return the manipulated image
 */
+(nullable AutomatID_OTMLImage*) transformImage:(nullable AutomatID_OTMLImage*)srcImage mirrotingHorizontal:(BOOL)hor;
 ...
 */
+(nullable AutomatID_OTMLImage*) transformImage:(nullable AutomatID_OTMLImage*)srcImage croppingWithRect:(CGRect)aCroppingRect;
 ...
 */
+(nullable AutomatID_OTMLImage*) transformImage:(nullable AutomatID_OTMLImage*)srcImage scalingToSize:(CGSize)aSize;
