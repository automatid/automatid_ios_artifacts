...
@interface AutomatID_SMJPropertyPathToken : AutomatID_SMJPathToken

// -- Instance --
- (nullable instancetype)initWithProperties:(NSArray <NSString *> *)properties delimiter:(unichar)delimiter error:(NSError **)error;

// -- Content --
@property (readonly) NSArray<NSString *> *properties;

@property (readonly) BOOL singlePropertyCase;
@property (readonly) BOOL multiPropertyMergeCase;
@property (readonly) BOOL multiPropertyIterationCase;
