//
//  AutomatID_OTMLContextContainerUtilities.h
//  OTMLFramework
//
...
@interface AutomatID_OTMLEdgeActive : NSObject
...
@interface AutomatID_OTMLTemporaryContextBackgroundView : UIImageView
