...
@protocol AutomatID_OTMLListTableAdapterDelegate <NSObject>
...
@interface AutomatID_OTMLTableListAdapterViewConfig : NSObject

-(id)initWithIndexPath:(NSIndexPath*) aIndexPath referemceSize:(CGSize) aReferemceSize fixedWidth:(BOOL)isFixedWidth fixedHeight:(BOOL)isFixedHeight refComponent:(AutomatID_OTMLComponent*)aRefComponent;
...
@property (nonatomic, weak) AutomatID_OTMLComponent* refComponent;

@end

@interface AutomatID_OTMLTableListAdapterSectionBean : NSObject

@property (nonatomic, strong) AutomatID_OTMLComponent* parent_table;
...
@property (nonatomic, weak) AutomatID_OTMLViewController* referenceOTMLVC;

-(void)setFilter:(NSObject<AutomatID_OTMLListTableProcedure>*)aProcedureFilter;
 ...
 */
@interface AutomatID_OTMLListTableAdapter : NSObject
 ...
 */
- (id)initForOTMLComponent:(AutomatID_OTMLComponent*)aReferenceComponent;
 ...
 */
- (BOOL) setupAdapterFromDs:(NSString*)aDSPath inOTVC:(AutomatID_OTMLViewController*) aOTMLVC;
 ...
 */
- (NSIndexSet*) appendSectionsInOTVC:(AutomatID_OTMLViewController*) aOTMLVC;
 ...
 */
-(AutomatID_OTMLComponent*) componentForCurrentConfig:(AutomatID_OTMLTableListAdapterViewConfig*)aConfig;
 ...
 */
-(UIView*)viewForCurrentConfig:(AutomatID_OTMLTableListAdapterViewConfig*)aConfig;
...
/**
 @discussion
  TODO
 */
-(AutomatID_OTMLComponent*) rootComponentAtCurrentIndexPath:(NSIndexPath*) aCurrentIndexPath;
 ...
 */
-(BOOL) setSectionDatasourceID:(NSString*) aSectionDataSourceID forSection:(NSUInteger) aSection withReferenceOTMLVC:(AutomatID_OTMLViewController*)aOtmlViewController;
 ...
 */
-(BOOL) insertSection:(AutomatID_OTMLTableListAdapterSectionBean*) aNewSection atIndex:(NSUInteger) aSectionIndex;
...
-(AutomatID_OTMLTableListAdapterSectionBean*) getSectionAtIndexPath:(NSUInteger)_index;
...
-(void) applyGlobalFilter:(NSObject<AutomatID_OTMLListTableProcedure>*)aGlobalProcedure __attribute__((deprecated));
 ...
 */
-(AutomatID_OTMLDatasource*)getElementForOriginalIndexPath:(NSIndexPath*)aCurrentIndexPath;
 ...
 */
-(NSIndexPath*)updateRowAtIndexPath:(NSIndexPath*)aOriginalIndexPath inOTVC:(AutomatID_OTMLViewController*) aOTMLVC;
...
+(NSMutableArray*) arrayOfSectionBeansFromDs:(NSString*)aDSPath
                                      inOTVC:(AutomatID_OTMLViewController*) aOTMLVC forParentTable:(AutomatID_OTMLComponent*) parent_table;


@property(nonatomic, weak) NSObject<AutomatID_OTMLListTableAdapterDelegate>* delegate;
