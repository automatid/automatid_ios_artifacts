//
//  AutomatID_OTMLAdvancedUpdaterManager.h
//  OTMLFramework
//
...
@protocol AutomatID_OTMLAdvancedUpdaterDelegate <NSObject>
...
//procedure completed
-(void)otmlUpdateDidFinishWithResult:(AutomatID_OTMLUpdateResult*)aResult andError:(NSError*)anError;
...
typedef NS_ENUM(unsigned int, AutomatID_OTMLUpdateProcedureStartReason) {
 ...
 */
@interface AutomatID_OTMLAdvancedUpdaterDelegateBase : NSObject <AutomatID_OTMLAdvancedUpdaterDelegate>

typedef void(^OTMLUpdateCallback)(AutomatID_OTMLUpdateResult*param, NSError*error);
...
@property (nonatomic, assign) AutomatID_OTMLUpdateProcedureStartReason startReason;
...
@interface AutomatID_OTMLAdvancedUpdaterManager : NSObject

@property (nonatomic, assign) BOOL isUpdating;
@property (nonatomic, strong, readonly) AutomatID_OTMLUpdTraceModel * updaterTrace;
@property (nonatomic, copy) void (^postUpdateCompletionBlock)(void);

+(instancetype)getInstance;

-(void)startOtmlUpdateProcedureWithDelegate:(AutomatID_OTMLAdvancedUpdaterDelegateBase*)aDelegate;
