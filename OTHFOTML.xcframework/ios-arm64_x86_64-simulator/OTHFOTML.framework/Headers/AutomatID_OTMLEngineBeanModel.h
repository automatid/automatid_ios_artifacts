...
@interface AutomatID_OTMLEngineBeanModel : NSObject
...
@property AutomatID_OTMPNetworkHmacSigningConfiguration* otml_hmac_signing_configuration;
...
@property AutomatID_OTMLCampaignAttributionConfiguration* campaignAttributionConfiguration;
/**
...
@property (nonatomic, strong) AutomatID_OTMLFont* skin_error_text_font;
...
@property (nonatomic, strong) AutomatID_OTMLFont* skin_otml_update_progressbar_loading_font;
...
@property (nonatomic, strong) AutomatID_OTMLFont* skin_toast_font;
...
@property (nonatomic, strong) AutomatID_OTMLFont* skin_keyboard_bar_text_font;
...
@property (nonatomic, strong) AutomatID_OTMLFont* ios_push_title_font;
@property (nonatomic, strong) AutomatID_OTMLFont* ios_push_subtitle_font;
...
-(void)setCertificatePinningValidCertificatesList:(NSArray<AutomatID_OTMPHTTPSCertificateModel*>*)certificatesList;
