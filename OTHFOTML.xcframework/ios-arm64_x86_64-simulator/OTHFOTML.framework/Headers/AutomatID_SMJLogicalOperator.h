...
@interface AutomatID_SMJLogicalOperator : NSObject

// -- Instance --
+ (AutomatID_SMJLogicalOperator *)logicalOperatorAND;
+ (AutomatID_SMJLogicalOperator *)logicalOperatorNOT;
+ (AutomatID_SMJLogicalOperator *)logicalOperatorOR;
