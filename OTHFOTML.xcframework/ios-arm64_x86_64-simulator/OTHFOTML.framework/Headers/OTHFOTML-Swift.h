...
#ifndef OTHFOTML_SWIFT_H
#define OTHFOTML_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="OTHFOTML",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC8OTHFOTML55AutomatID_OTMLAddPushNotificationBlacklistActionCommand")
...
@class NSString;
@class NSObject;
SWIFT_CLASS("_TtC8OTHFOTML43AutomatID_OTMLPushNotificationActionCommand")
...
SWIFT_CLASS("_TtC8OTHFOTML44AutomatID_OTMLPushNotificationBlacklistRules")
...
@class UIView;
SWIFT_CLASS("_TtC8OTHFOTML35AutomatID_OTMLSliderButtonComponent")
...
@class NSCoder;
SWIFT_CLASS("_TtC8OTHFOTML21OTMLLottieViewWrapper")
@interface OTMLLottieViewWrapper : UIView
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
- (void)stop;
- (void)reset;
- (void)setAnimationLoop:(BOOL)shouldLoop;
- (void)setAnimationWithJson:(NSString * _Nonnull)json;
- (void)playWithCompletion:(void (^ _Nonnull)(BOOL))completion;
- (void)setAnimationWithFileName:(NSString * _Nonnull)fileName;
- (void)play;
@end

SWIFT_CLASS("_TtC8OTHFOTML48OTMLRemovePushNotificationBlacklistActionCommand")
@interface OTMLRemovePushNotificationBlacklistActionCommand : AutomatID_OTMLActionCommand
- (void)executeResolvedAction:(AutomatID_OTMLResolvedAction * _Null_unspecified)aAction onViewController:(AutomatID_OTMLViewController * _Null_unspecified)aNestingVC;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

SWIFT_CLASS("_TtC8OTHFOTML24OTMPNetworkHmacSupporter")
