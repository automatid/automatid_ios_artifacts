...
@interface AutomatID_SMJCharacterIndex : NSObject
...
- (AutomatID_SMJCharacterIndex *)skipBlanks;
- (AutomatID_SMJCharacterIndex *)skipBlanksAtEnd;

- (AutomatID_SMJCharacterIndex *)trim;
