//
//  AutomatID_OTMLAppExposedHooks.h
//  OTML
//
...
@interface AutomatID_OTMLAppExposedHooks : NSObject
...
/*
 ...
 Depending on app requirements, it may or may not be necessary to call [[AutomatID_OTMLAskPushTokenCommand getInstance] triggerPushTokenDidCompletedSuccessfullyWithToken:] with the token you have obtained from the data in the devToken parameter.
 */
