//
//  AutomatID_OTMPNetworkHmacSigningConfiguration.h
//  OTML
//
...
@interface AutomatID_OTMPNetworkHmacSigningConfiguration : NSObject
...
+ (AutomatID_OTMPNetworkHmacSigningConfiguration*)getInstance;
