...
@protocol AutomatID_OTMPTrackLocationDelegate;

@interface AutomatID_OTMLLocationSearchBean : NSObject
...
@interface AutomatID_OTMLLocationProvider : NSObject <AutomatID_OTMLRestartAppAwareProtocol, AutomatID_OTMPTrackLocationDelegate>
#ifndef EXCLUDE_COCOA_CORE_LOCATION
@property (nonatomic, readonly) CLLocation* lastLocation;
#endif


+(AutomatID_OTMLLocationProvider*)getInstance;
-(void)startLocationWithSearchBean:(AutomatID_OTMLLocationSearchBean*)aSearchBean;
-(void)stopLocation;
