...
@interface AutomatID_OTMPAbstractDatePicker : UIControl
...
@protocol AutomatID_OTMPDatePickerValueChangeDelegate <NSObject>
 ...
 **/
@interface AutomatID_OTMPDatePicker : NSObject
...
@property (nonatomic, retain) NSObject<AutomatID_OTMPDatePickerValueChangeDelegate>* valueChangeDelegate;
