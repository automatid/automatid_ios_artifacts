...
} AutomatID_NTMonthYearPickerMode;

@interface AutomatID_NTMonthYearPicker : UIControl <NSCoding>

// The mode of the date picker - see the NTMonthYearPickerMode enum
// Default is NTMonthYearPickerModeMonthAndYear
@property (nonatomic) AutomatID_NTMonthYearPickerMode datePickerMode;
