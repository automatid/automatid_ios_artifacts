//
//  AutomatID_OTMLCCUtils.h
//  Pods
//
//  Created by Enrico on 13/02/2020.
//
@interface AutomatID_OTMLCCUtils : NSObject

typedef enum {
    AutomatID_OTMLCCUtils_Region_EU = 0,
    AutomatID_OTMLCCUtils_Region_Global = 1
} AutomatID_OTMLCCUtils_Region;
...
+(AutomatID_OTMLCCUtils_Region) regionFromString:(nullable NSString*) aStringValue;
+(nonnull NSString*) stringFromRegion:(AutomatID_OTMLCCUtils_Region) aValue;
