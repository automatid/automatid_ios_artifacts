//
//  AutomatID_OTMPFileManagerFactory.h
//  OTMLFramework
//
...
#import <OTHFOTMLCore/AutomatID_OTMPFileHandler.h>
#import <OTHFOTMLCore/AutomatID_OTMPSecureFileHandler.h>
#import <OTHFOTMLCore/AutomatID_OTMPSecureFileHandler.h>
#import <OTHFOTMLCore/AutomatID_OTMLRestartAppAwareProtocol.h>
#import <OTHFOTMLCore/AutomatID_OTMLDumpableModuleProtocol.h>


@interface AutomatID_OTMPFileManagerConfiguration : NSObject
...
@interface AutomatID_OTMPFileManagerFactory : NSObject <AutomatID_OTMLDumpableModuleProtocol>

+(void)setupFileManagerConfiguration:(nonnull AutomatID_OTMPFileManagerConfiguration*)aConfiguration;
...
+(nonnull AutomatID_OTMPFileHandler*)basicFileManager;
+(nonnull AutomatID_OTMPSecureFileHandler*)secureFileManager;
